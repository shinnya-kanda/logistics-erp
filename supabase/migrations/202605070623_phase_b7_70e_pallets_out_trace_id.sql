-- Phase B7-70E: pallets-out trace_id write support
--
-- 方針:
-- - pallets-out の業務単位 trace_id を OUT 履歴の pallet_transactions に保存する
...
grant execute on function public.out_pallet(text, text, text, text, text, text, text, text)
